...
public class Constants {
	...
	public static int honBaoCount = 5;
	...
	*/
	public static String getHongBaoScript =   
		            ...
		            "if redis.call('sismember', KEYS[3], KEYS[4]) == 1 then\n"   + 
		                 "return nil\n" + 
		            "else\n"  +
		                  //从红包池取出一个小红包
	...
	public static String getTestScript= "return nil;";
}
